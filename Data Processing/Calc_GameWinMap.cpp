...
int main()
{
    ...
    out<< "Zerg win over Protoss: " << ZwinvP<<endl;
    out<< "Zerg win over Terran: " << ZwinvT<<endl;
    out<< "Terran win over Zerg: " << TwinvZ<<endl;
    out<< "Terran win over Protoss: " << TwinvP<<endl;
    out<< "Protoss win over Terran: " << PwinvT<<endl;
    out<< "Protoss win over Zerg: " << PwinvZ<<endl;
    out<< "Number of same race game: "<<sameracegame<<endl;
    out.close();
