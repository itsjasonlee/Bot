...
#include <string>
using namespace std;
//This program calculates the time in which races lose
...
int main()
{
	...
	outWinTimeGameZerg.open("Calc_LoseTimeZerg.log");
	ofstream outWinTimeGameProtoss;
	outWinTimeGameProtoss.open("Calc_LoseTimeProtoss.log");
	ofstream outWinTimeGameTerran;
	outWinTimeGameTerran.open("Calc_LoseTimeTerran.log");
